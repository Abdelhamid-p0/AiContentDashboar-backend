 ...
 * import
 * com.quiz.ai.prompt_builder_module.dto.correction.QuestionCorrectionResponse;
 * import com.quiz.ai.prompt_builder_module.service.PromptSettingsService;
 ...
 * tokens.put("level", valueOrEmpty(course.getLevel() == null ? null :
 * course.getLevel().getLevelName()));
 * tokens.put("subject", valueOrEmpty(course.getSubject() == null ? null :
 * course.getSubject().getTitle()));
 * tokens.put("domain", valueOrEmpty(course.getDomain() == null ? null :
 * course.getDomain().getTitle()));
 * tokens.put("semester", valueOrEmpty(course.getSemester() == null ? null :
 * course.getSemester().name()));
 * tokens.put("pedagogical_rules",
 * valueOrEmpty(settings.getPedagogicalRules()));
 ...
 * var settings = promptSettingsService.getPromptSettings();
 * String questionJson = toJson(buildQuestionPayload(question));
 * String previousCorrectionJson = previousCorrection == null ? "null" :
 * toJson(previousCorrection);
 ...
 * payload.put("question_type", question.getQuestionType() != null ?
 ...
 * payload.put("objective", question.getObjective() == null ? null :
 * buildObjectivePayload(question));
